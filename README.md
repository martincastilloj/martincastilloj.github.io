...
- `escritos/index.html`: archivo general de escritos y publicaciones.
- `ceaps/index.html`: archivo personal de participacion en CEAPS.
- `assets/css/styles.css`: estilos principales del sitio.
- `assets/css/article.css`: estilos para paginas de escritos.
- `assets/css/publications.css`: estilos del archivo de escritos.
- `assets/css/ceaps.css`: estilos del archivo personal CEAPS.
